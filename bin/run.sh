...
function start () {
    ...
    uwsgi --http 0.0.0.0:5000 --enable-threads --processes 4 --threads 4 --master --max-requests 300 --thunder-lock --listen 4096 --post-buffering 4192 --module app.main:application
